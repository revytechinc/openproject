...
import LiveUpdatesController from './controllers/dynamic/work-packages/live-updates.controller';
...
OpenProjectStimulusApplication.preregister('work-packages--live-updates', LiveUpdatesController);
